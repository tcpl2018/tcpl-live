...
<title>Manufacturing-ERP Software Solutions, India | Team Computers</title>
<meta name="description" content="Team Computers manufacturing ERP software solutions offers all process & function on single platform including production, inventory, purchase, finance, vendor management and many more." />
...
<section class="banner-cover">
  <div class="banner">
    ...
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Manufacturing - <br>
ERP Software Solutions</h1>
        <h2>Software solutions <br>
for Manufacturing</h2> 
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Reduced Turn around and lead time </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Shelf life expiry management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
