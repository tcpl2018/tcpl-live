...
<title>Construction - ERP & Management Software, India | Team Computers</title>
<meta name="description" content="Construction comapny ERP software helps real state industry in managing sales, accounts, inventory, projects and many more." />
    ...
    <div class="solutions-inner clearfix">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Procurement process on the go</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Plant, machinery & Vehicle management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>rade finance – LOC, Bank guarantee, multi-currency, collateral management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
