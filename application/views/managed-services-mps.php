...
<title>Managed Print Services, Print Management, India | Team Computers</title>
<meta name="description" content="Team Computers managed print services assist businesses transform high printing experience in lower cost by optimizing your printing environment." />
...
<section class="cmn-padd insights auto-ana man-ser">
  <div class="container">
...
Historical 
Data</span> </p>
              <p>Extract the hidden truth behind your performance data. </p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
...
Cause 
Analysis</p>
              <p>Isolate the issue where it occurs and when.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
...
Proactive 
Maintenance</p>
              <p>Reduce often recurring issues to optimize workloads. </p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
          <div class="insight-cmn-bx box4">
            <div class="insights-icon clearfix">
              ...
              <p>Remote 
Management </p>
              <p>Make use of our dedicated and shared support services till the last mile to keep your systems up and running.  </p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<section class="cmn-padd solutions use-cases mps">
  <div class="container">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
				<img src="images/ven-part-pri.png" alt="vendor part pricing icon">
              <p>Printing outsourced – includes printers, consumables, cartridges, maintenance & guaranteed uptime.</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Enhanced security through PIN and RFID based printing</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Multi vendor support through Partnership with all leading OEMs</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Optimization of the print fleet across offices or locations thereby cutting costs and complexity</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Specialized and dedicated VIP support </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
		...
		<div class="solutions-inner clearfix">
			...
			<div id="partner-carousel" class="owl-carousel owl-theme">
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Managed-Print-Services/Epson.png" alt="Epson partner"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Managed-Print-Services/Konica-Minolta.png" alt="Konica Minolta"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Managed-Print-Services/Kyocera.png" alt="Kyocera"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Managed-Print-Services/Samsung.png" alt="Samsung"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Managed-Print-Services/Xerox.png" alt="Xerox"> </figure>
				</div>
			</div>
		</div>
	</div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_managed_services_mps();
  ...
  <div class="container exp-more">
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        <div class="dig-ag"><a href="managed-services-dcnm">
          ...
          <br>
          Data Center & <br>
Network Management</a></div>
        <div class="dig-ag"><a href="managed-services-eums">
          <div class="valigncenter img-box">
			<i>
       ...
       End User <br> Managed 
 Services</a></div>
		  <div class="dig-ag"><a href="managed-services-mbbf">
          <div class="valigncenter img-box">
			  <i>
          ...
          Multi brand <br>
Break Fix (AMC)</a></div>
		  <div class="dig-ag"><a href="managed-services-sas">
          <div class="valigncenter img-box">
			  <i>
...
<section class="cmn-padd job-dec pos cmn-padd cmn-box hap-cus">
  <div class="container clearfix">
    <h2 class="cmn-hdr">
        <span class="line-text">1000+ Happy Customers</span>
      </h2>
