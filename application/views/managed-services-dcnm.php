...
<title>Data Center & Network Management Services, India | Team Computers</title>
<meta name="description" content="Team Computers management services enable businesses to achieve crisis ready data center & network, with zero down time support.  "/>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>24 X 7 Support across the world</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Server Management – System Administration & OS Management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Messaging Support Services</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Storage Management – backup & restore services</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Virtualization Support Services</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Industry leading automation and tools </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Hazardous Material & MSDS management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
		...
		<div class="solutions-inner clearfix">
			...
			<div id="partner-carousel" class="owl-carousel owl-theme">
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Data-Center-and-Network-Management/manageengine.png" alt="manageengine"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Data-Center-and-Network-Management/Sapphireims.png" alt="Sapphireims"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/Data-Center-and-Network-Management/Symphony-Summit.png" alt="Symphony Summit"> </figure>
				</div>
			</div>
		</div>
	</div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_managed_services_dcnm();
...
Managed Services</a></div>
        <div class="dig-ag"><a href="managed-services-mps">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Managed <br>
Print Services</a></div>
		  <div class="dig-ag"><a href="managed-services-mbbf">
          <div class="valigncenter img-box"><i>
