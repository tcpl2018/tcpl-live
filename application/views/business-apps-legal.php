...
<title>Law Firm ERP & Case Management Software, India | Team Computers</title>
<meta name="description" content="Law firm ERP software includes all functions & operations like billing, accounting, case, time record, documents and processes on single platform. " />
...
<section class="banner-cover">
  <div class="banner bapps-legal">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Law Firm ERP &<br> Case Management Software</h1>
        <h2>Case to case systems</h2> 
        ...
        <div class="col-md-3 col-xs-12 col-sm-4">
          <div class="insight-cmn-bx box1">
            <div class="insights-icon clearfix">
              ...
              <p>Make use of our consulting services to identify your business requirement.  Arrive at an implementation roadmap.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
          <div class="insight-cmn-bx box2">
            <div class="insights-icon clearfix">
              ...
              <p>Implement</p>
              <p>Manage the full cycle of implementation with complete customization and integration with Third party products.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
          <div class="insight-cmn-bx box3">
            <div class="insights-icon clearfix">
              ...
              <p>Upgrade</p>
              <p>Upgrade from traditional ERP, CRM, HRMS, DMS systems and migrate to the latest from Microsoft.  </p>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 col-sm-4">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Branch-wise, visibility of operations</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Elimination of duplicity of work</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Dashboard tracking of all functions</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Visibility of resource availabilty & work Status</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Foreign associate billing in tegrated with debiting system</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Minimize time leakage in the firm</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_business_apps_manufacturing();
          foreach ($getAllCasestudies as $getAllCasestudy) {
            if(isset($getAllCasestudy) == "Infrastructure Solutions" && $getAllCasestudy['sub_solution_name'] == "Business Apps" && empty($getAllCasestudy['vertical'])){
        ?>
  ...
  <div class="container exp-more">
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        <div class="dig-ag"><a href="business-apps-oil-and-gas">
          ...
          <br>
          Oil & Gas</a></div>
        <div class="dig-ag"><a href="business-apps-construction">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Construction</a></div>
		  <div class="dig-ag"><a href="business-apps-manufacturing">
          <div class="valigncenter img-box">
			  <i>
          ...
          <br>
          Manufacturing</a></div>
		  <div class="dig-ag"><a href="business-apps-pharma">
          <div class="valigncenter img-box">
			  <i>
		  ...
		  <div class="dig-ag"><a href="business-apps-chemicals">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Chemicals</a></div>
		  <div class="dig-ag"><a href="business-apps-fmcg">
          <div class="valigncenter img-box">
			  <i>
