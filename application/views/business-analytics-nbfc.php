...
<title>Non Banking Financial Company(NBFC) Analytics Solutions | Team Computers</title>
<meta name="description" content="Detect fraud and make financial transaction easy in NBFC using Team Computers analytics solutions." />
...
<section class="banner-cover">
  <div class="banner ba-nbfc">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Non Banking Financial <br>
Company(NBFC) Analytics Solutions</h1>
        <h2>Lending and Collections <br>
based on data.</h2> 
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/ven-part-pri.png" alt="vendor part pricing icon">
              <p>RBI Report Repository</p>
              <div class="clearfix"></div>
              <p>Automate and improve accuracy of daily, monthly, quarterly and yearly regulatory reporting. Save time and eliminate errors.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>NPA Analyzer</p>
              <div class="clearfix"></div>
              <p>Classify your assets, discover hidden NPAs, identify problem cases early on and take prompt measures for recovery. Reap the benefits of an efficient asset management process.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              ...
              <div class="clearfix"></div>
              <p>Monitor deposits, advance, interest earned and paid, net interest margin, EMIs due and float funds available. Track the movement of KPIs paramount to the health of your business.
</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Operations</p>
              <div class="clearfix"></div>
              <p>Regular monitoring of operations to keep track of Customer Retention, Cross Selling products to customers, Customer categorization, Customer Penetration, Asset Quality & Capital Adequacy.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<?php
$getAllCasestudies = $this->site_mdl->getMainCaseStudyAnalyticsNBFC();
