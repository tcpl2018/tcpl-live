...
<title>Chatbots Business Analytics & Intelligence, India | Team Computers</title>
<meta name="description" content="Now intract with your data by using Team Computers Analytics Chatbots. It's always on and never disappoints." />
...
<section class="banner-cover">
  <div class="banner chatbot-banner">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Chatbots Business Analytics<br> & Intelligence</h1>
        <h2>Always available, never clueless.</h2> 
...
<section class="cmn-padd insight use-cases chatbot-sec bac">
  <div class="container">
    <div class="solutions-inner clearfix">
		<h2 class="sec-hd">Automated and intelligent answers. To most oft <br>
repeated queries. Available all the time.</h2>
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p><span>Powered by AI</span>Stimulated by Artificial Intelligence, Machine learning and Location Mapping. Get apt responses to your questions, based on your context.</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p><span>Natural Language Processing</span>You won’t be able to guess if you are talking to a person or a robot if we don’t tell you. You can converse with your chatbot just like you’d talk to a real person.</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p><span>Personalized</span>Experience a growth in your efficiency as the chatbot adapts to your habits and proactively offers you the information you need to be at the top of your game. </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p><span>Quick Access to Charts and Reports</span> No need to log in to a browser or an application to look at a chart or report. Call for it through your chatbot and receive it in an instant!</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p><span>Focus on Important Changes</span>Never again miss any red flags in your sales and operations. Get notified by setting alerts triggered through an incident.</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p><span>Fuel the Data Culture</span>Share your insights directly with your colleagues and partners through popular messaging platforms. </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
