...
<title>Pharma-ERP  Software Services & Solutions, India | Team Computers</title>
<meta name="description" content="Managing & reporting pharma industry proccess now become easy with Team Computers ERP  Software solutions." />
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Multi-level BOM & yield management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Quality control sample management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Batch wise product costing/profitability </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Waste Disposal and Efﬂuent Treatment</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
