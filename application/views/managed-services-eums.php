...
<title>End User Managed Services</title>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Unmatched country wide presence</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Self Help Chatbots for quick resolution</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Automation tools for self heal - preventing occurrence of incidents</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Proactive end user services to increase productivity</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Asset and inventory management to aid your rapidly expanding business</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
		...
		<div class="solutions-inner clearfix">
			...
			<div id="partner-carousel" class="owl-carousel owl-theme">
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/End-user-Managed-Services/manageengine.png" alt="manageengine"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/End-user-Managed-Services/Sapphireims.png" alt="Sapphireims"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/Managed-Services/End-user-Managed-Services/Symphony-Summit.png" alt="Symphony Summit"> </figure>
				</div>
			</div>
		</div>
	</div>
...
<div class="clearfix"></div>
 <?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_managed_services_eums();
