...
<section class="cmn-padd insights">
  <div class="container">
    <div class="insight-inner clearfix">
      <h2 class="sec-hd">Delivered anywhere in India.</h2>
      <div class="row">
...
roll out
              ...
              <p>200 branch roll out PAN India in flat 60 days. 
</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box4">
            <div class="insights-icon clearfix">
              <p>Higher <br> productivity </p>
              <p>Empower your workforce with industry leading end user devices. A leading VFX company reduced designing output from 7 days to 48 hours.
</p>
            </div>
          </div>
        </div>
...
<section class="cmn-padd rel-solutions mas-sec">
  <div class="container">
    <div class="solutions-inner clearfix">
      <h2 class="cmn-hdr">
        <span class="line-text">See how we are moving Computing</span>
      </h2>
      <div class="grid">
