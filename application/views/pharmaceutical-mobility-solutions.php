...
<title>Pharmaceutical Mobility Solutions & Mobility Services | Team Computers </title>
<meta name="description" content="It's time to upgrade your pharmaceutical business from legacy systems to mobile platform. Team Computers brings Pharmaceutical Mobility Solutions that makes operating your business easier." />
...
<section class="banner-cover">
  <div class="banner pharma-mobi">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Pharmaceutical Mobility Solutions <br>
& Mobility Services
</h1>
        <h2>No need to carry <br>
heavy drug manuals.</h2> 
        ...
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box1">
            <div class="insights-icon clearfix">
              ...
              <p>Create your mobility strategy for your business environment, Industry or the current hardware you use.</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
...
development 
& Pilot</p>
              <p>Apps by business and Industry customized to your needs. Includes Benchmarking, Policy compliance, Usage and Device comparisons.</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
...
Device 
management </p>
              <p>Custom & remote deployment with Preloaded business Apps with support. Identify & flag non-compliant usage, push critical applications, create and modify User interface.</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box4">
            <div class="insights-icon clearfix">
              ...
              <p>Delivery</p>
              <p>Fast and seamless delivery anywhere in India.</p>
            </div>
          </div>
        </div>  
		<div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box5">
            <div class="insights-icon clearfix">
              ...
              <p>Enterprise 
support</p>
              <p>Last mile support across India, Extended service window, Onsite support & End to end managed services. </p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<section class="cmn-padd solutions use-cases baoag">
  <div class="container">
    <div class="solutions-inner clearfix">
      <h2 class="cmn-hdr">
        <span class="line-text">Benefits</span>
      </h2>
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>More calls per day per rep</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Better recall from physicians</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_pharmaceutical_mobility_solutions();
          foreach ($getAllCasestudies as $getAllCasestudy) {
            if(isset($getAllCasestudy) == "Infrastructure Solutions" && $getAllCasestudy['sub_solution_name'] == "Mobility" && empty($getAllCasestudy['vertical'])){
        ?>
    ...
    <div class="bms-txt col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
        <div class="bms-txt-inner">
          <div class="p-cover">
            ...
            <p class="txt"><?php echo echoStr(substr($getAllCasestudy['case_overview'],0,310));?></p>
  ...
  <div class="container exp-more">
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        <div class="dig-ag"><a href="mobile-banking-solutions">
          ...
          <br>
          Banking</a></div>
        <div class="dig-ag"><a href="insurance-mobility-solutions">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Insurance</a></div>
		  <div class="dig-ag"><a href="retail-mobility-services">
          <div class="valigncenter img-box">
			  <i>
          ...
          <br>
          Consumer Goods</a></div>
		  <div class="dig-ag"><a href="manufacturing-enterprise-mobility">
          <div class="valigncenter img-box">
			  <i>
        ...
        <div class="soc-info"> <img src="images/cta-arr.png" alt="CTA arrow">
          <div class="key-con-txt">
            ...
            <ul>
              ...
              <li><a href="https://www.linkedin.com/in/maheshtomar/"><i class="fa fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
