...
<title>Mobile Banking Solutions & Mobility Services | Team Computers </title>
<meta name="description" content="Team Computers mobile banking solutions helps banks improve their customer experience by providing them mobile devices & apps for easy banking." />
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Shorten account opening cycle</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_mobile_banking_solutions();
