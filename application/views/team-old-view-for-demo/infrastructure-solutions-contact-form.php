...
if ( isset( $_POST[ 'action' ] ) && $_POST[ 'action' ] == "contact1" ) {
	...
	if (empty($Name)) {
		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Your Name</b></div>';
	}elseif ( empty( $_POST[ 'phone' ] ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Valid Phone No.</b></div>';
	} elseif ( !preg_match( '/[2-9]{2}\d{8}/', $_POST[ 'phone' ] ) ) {
		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Enter Min 10 Numeric Value!</b></div>';
	} elseif ( empty( $_POST[ 'email' ] ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Your Email</b></div>';

	} elseif ( !filter_var( $_POST[ 'email' ], FILTER_VALIDATE_EMAIL ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Your Valid Email</b></div>';

	} elseif ( empty( $_POST[ 'enquiry' ] ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Select a Solution Type</b></div>';
	} elseif ( empty( $_POST[ 'message' ] ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please write message</b></div>';
	}elseif ( empty( $_POST[ 'letters_code' ] ) ) {

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Captcha Code</b></div>';

	} elseif ( isset( $_POST[ "letters_code" ] ) && ( $_SESSION[ "6_letters_code" ] != $_POST[ "letters_code" ] ) )

	{

		$_SESSION[ 'msgs' ] = '<div class="alert alert-danger" style="font-size:auto;"><span>Error: </span><b>Please Enter Correct Captcha Code</b></div>';
...
<?php include("include/analyticstracking.php"); ?>
	...
	<div class="body-content innner-body-con">
		<section class="solutions-banner clearfix">
			<div class="container">
				<h1>Contact <span><em>Infrastructure Solutions</em></span></h1>
			</div>
		</section>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select class="form-control" name="enquiry">
													...
													<option value="Collaboration_Solutions" <?php if($_POST[ 'enquiry']=="Collaboration_Solutions" ) echo "selected"; ?>>Collaboration Solutions</option>
													<option value="Data_Center_Built_Virtualization" <?php if($_POST[ 'enquiry']=="Data_Center_Built_Virtualization" ) echo "selected"; ?>>Data Center Built &amp; Virtualization</option>
													<option value="Surveillance_Access_Control" <?php if($_POST[ 'enquiry']=="Surveillance_Access_Control" ) echo "selected"; ?>>Surveillance &amp; Access Control</option>
													<option value="Mobility_Computing_Solutions" <?php if($_POST[ 'enquiry']=="Mobility_Computing_Solutions" ) echo "selected"; ?>>Mobility &amp; Computing Solutions</option>
												</select>
											</div>
										</div>
									</div>
