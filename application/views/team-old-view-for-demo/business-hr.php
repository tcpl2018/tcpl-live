...
<body>
	...
	<div class="body-content innner-body-con">
		<section class="solutions-banner clearfix">
			<div class="container">
				<h1 class="career-fnt col-md-12">Business HR</h1>
								...
								<div class="col-md-8 cr-txt">
									<ul>
										<li><span>Job Description</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>A person with a strategic mindset and strong Business Acumen, in IT sector preferably.</li>
												<li><i class="fa fa-circle"></i>Good Knowledge about the trends and changes in the domain of HR. HR becoming a business partner.</li>
												<li><i class="fa fa-circle"></i>Proactively involved in taking the necessary steps. Making business people centric.</li>
												<li><i class="fa fa-circle"></i>Good communication and interpersonal Skills in order to build relations with all the stakeholders.</li>
										</ul>
										
									<ul><li><span>Qualification and Experience</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>MBA HR- or B.Tec/ M.Tech</li>
											</ul>
										</li>
									</ul>
