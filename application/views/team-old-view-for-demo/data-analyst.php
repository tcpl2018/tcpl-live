...
<body>
	...
	<div class="body-content innner-body-con">
		<section class="solutions-banner clearfix">
			<div class="container">
				<h1 class="career-fnt col-md-12">Data Analyst</h1>
								...
								<div class="col-md-8 cr-txt">
									<ul>
										<li><span>Job Description</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>Looking for a passionate Data Analyst.</li>
												<li><i class="fa fa-circle"></i>The successful candidate will turn data into information, information into insight and insight into business decisions.</li>
												<li><i class="fa fa-circle"></i>Data analyst responsibilities include conducting full life cycle analysis to include requirements, activities, and design. Data analysts will develop analysis and reporting capabilities. </li>
												<li><i class="fa fa-circle"></i>They will also monitor performance and quality control plans to identify improvements.</li>
									...
									<ul>
										...
										<li><span>Qualification and Experience</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>Location - NCR/ Mumbai</li>
												<li><i class="fa fa-circle"></i>Experience - 0-2 years</li>
												<li><i class="fa fa-circle"></i>Number of Positions - 3</li>
											</ul>
										</li>
									</ul>
