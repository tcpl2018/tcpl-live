						...
						<div class="row">
							<div class="container clearfix">
								<div class="col-md-8 cr-txt">
									<ul>
										<li>
											<p>Sales & Business development, evaluating market for new business opportunities, key account management, handling of corporate tie-ups, maintaining relationship with existing clients, implement defined marketing strategies, to achieve targeted sales.  The ideal candidate should be MBA Graduate or any graduate,identifying market for Company's Products</p>
											
										</li>
									<ul>
										<li><span>Generating new business, selling of Infrastructure solutions/ Product,
We offer our customers an entire range of products/ Infrastructure solutions:</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>Data Center Solutions</li>
												<li><i class="fa fa-circle"></i>Business Computing services</li>
												<li><i class="fa fa-circle"></i>Information Security and Availability Services</li>
												<li><i class="fa fa-circle"></i>Server Solutions</li>
												<li><i class="fa fa-circle"></i>Storage Solutions</li>
												<li><i class="fa fa-circle"></i>Networking Solutions</li>
												<li><i class="fa fa-circle"></i>Power Solution and network security Solutions</li>
												<li><i class="fa fa-circle"></i>Software Services & Compliance</li>
												<li><i class="fa fa-circle"></i>Conference Room Solutions & Surveillance</li>
												<li><i class="fa fa-circle"></i>Cloud Computing Solutions </li>
											</ul>
										</li>
										
										<li><span>Major job responsibilities will include:</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>Handling corporate tie-ups.</li>
												<li><i class="fa fa-circle"></i>Maintaining relations with clients, etc.</li>
												<li><i class="fa fa-circle"></i>Evaluation of the potential of corporate agencies.</li>
												<li><i class="fa fa-circle"></i> Collecting competitor information on supplementary distribution business.</li>
												<li><i class="fa fa-circle"></i>Retention, Enhancement & Deepening relationships with the clients</li>	
												<li><i class="fa fa-circle"></i>To implement defined marketing strategies, to achieve targeted sales, to ensure increase market share. To develop and maintain close rapport with customers .Should have the ability to work cooperatively in a team & proactive temperament.</li>
											</ul>
											...
											<ul class="sub-list">
												...
												<li><i class="fa fa-circle"></i>Experience: 1 to 8 yrs</li>
												<li><i class="fa fa-circle"></i>Number of Positions - 70</li>
											</ul>
										</li>
									</ul>
