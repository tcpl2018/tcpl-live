								...
								<div class="col-md-8 cr-txt">
									<ul>
										<li><span>Job Description:</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>A good knowledge of the Google ecosystem (Google App engine)</li>
												<li><i class="fa fa-circle"></i>Experience designing, developing, deploying & Supporting large scale distributed systems and API development.
												<li><i class="fa fa-circle"></i>Solid understanding of object-oriented programming</li>
												<li><i class="fa fa-circle"></i>Familiar with various design and architectural patterns</li>
												<li><i class="fa fa-circle"></i>Skill for writing reusable Java libraries</li>
												<li><i class="fa fa-circle"></i>Knowledge of concurrency patterns in Java</li>
												<li><i class="fa fa-circle"></i>Familiarity with concepts of MVC, JDBC, and RESTful</li>
												<li><i class="fa fa-circle"></i>Knack for writing clean, readable Java code</li>
												<li><i class="fa fa-circle"></i>Experience with both external and embedded databases</li>
												<li><i class="fa fa-circle"></i>Understanding fundamental design principles behind a scalable application</li>
												<li><i class="fa fa-circle"></i>Basic understanding of the class loading mechanism in Java</li>
												<li><i class="fa fa-circle"></i>Creating database schemas that represent and support business processes</li>
												<li><i class="fa fa-circle"></i>Basic understanding of JVM, its limitations, weaknesses, and workarounds</li>
												<li><i class="fa fa-circle"></i>Proficient understanding of code versioning tools, such as Git, SVN</li>
												<li><i class="fa fa-circle"></i>Basic Knowledge of Web Technologies like HTML, CSS, Javascript and Jquery</li>
											</ul>
										</li>
										
										<li><span>Key Skills and Experience:</span>
											<ul class="sub-list">
												<li><i class="fa fa-circle"></i>Core Java, JSP / Servlets, REST Web Services - SOAP / REST, JSON And XML.</li>
												<li><i class="fa fa-circle"></i>Experience - 4 - 5 years</li>
												<li><i class="fa fa-circle"></i>Number of Positions - 2</li>
												<li><i class="fa fa-circle"></i>Location - NCR</li>
											</ul>
										</li>
									</ul>
