...
if ( isset( $_POST[ 'action' ] ) && $_POST[ 'action' ] == "contact1" ) {
...

	{
		...
		$mailSubject = "Inquiry from Teamcomputers website: Apps & Mobility " . $date_time . "";
...
";
		...
		if ( mail( $mailTo, $mailSubject, $mailBody, $mailHeader ) ) {
			...
			//runQuery($db,$sql);
			echo "<script>window.location.href='/apps-and-mobility-success';</script>";
		} else {
...
<?php include("include/analyticstracking.php"); ?>
	...
	<div class="body-content innner-body-con">
		<section class="solutions-banner clearfix">
			<div class="container">
				<h1>Contact <span><em>Apps & Mobility</em></span></h1>
			</div>
		</section>
		...
		<div class="container">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select class="form-control" name="enquiry">
											...
											<option value="Mobility_Solutions" <?php if($_POST[ 'enquiry']=="Mobility_Solutions" ) echo "selected"; ?>>Mobility Solutions</option>
											<option value="App_Development" <?php if($_POST[ 'enquiry']=="App_development" ) echo "selected"; ?>>App development</option>
											<option value="Enterprise_Applications" <?php if($_POST[ 'enquiry']=="Enterprise_Applications" ) echo "selected"; ?>>Enterprise Applications</option>
			...
			<div class="col-md-4 col-sm-4 tpadding50 cli-part-box clearfix">
				<div class="row">
					<div class="white-bg">
						<div class="client-sec clearfix">
							<div class="col-md-10">
								<div class="row">
									...
									<div class="clearfix"></div>
									<a href="our-teams">See all our clients</a>
								</div>
							</div>
