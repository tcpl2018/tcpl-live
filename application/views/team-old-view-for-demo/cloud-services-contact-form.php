<?php //if ( isset( $_POST[ 'action' ] ) && $_POST[ 'action' ] == "contact" ) {
...
if ( isset( $_POST[ 'action' ] ) && $_POST[ 'action' ] == "contact1" ) {
...

	{
		...
		$mailTo = 'shivali.s@teamcomputers.com,dilshad.hussain@teamcomputers.com,social@teamcomputers.com,sandeep.saini@teamcomputers.com,salim.ansari@teamcomputers.com';
...
<?php include("include/analyticstracking.php"); ?>
	...
	<div class="body-content innner-body-con">
		<section class="solutions-banner clearfix">
			<div class="container">
				<h1>Contact <span><em>Cloud Services</em></span></h1>
			</div>
		</section>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="email" id="inputEmail" name="email" email="true" class="form-control" autocomplete="off" placeholder="E-mail" value="<?php if(isset($_POST['email']) && !empty($_POST['email'])){ echo $_POST['email']; }?>">
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<select class="form-control" name="enquiry">
													...
													<option value="Cloud_Consulting" <?php if($_POST[ 'enquiry']=="Cloud_Consulting" ) echo "selected"; ?>>Cloud Consulting</option>
													<option value="Cloud_Migration" <?php if($_POST[ 'enquiry']=="Data_Center_Built_Virtualization" ) echo "selected"; ?>>Cloud Migration</option>
													<option value="Architecting_Cloud_Infrastructure" <?php if($_POST[ 'enquiry']=="Architecting_Cloud_Infrastructure" ) echo "selected"; ?>>Architecting Cloud Infrastructure</option>
													<option value="Sizing_Re_sizing_IT_Infrastructure_on_Cloud" <?php if($_POST[ 'enquiry']=="Sizing_Re_sizing_IT_Infrastructure_on_Cloud" ) echo "selected"; ?>>Sizing & Re-sizing IT Infrastructure on Cloud</option>
													<option value="Messaging_Collaboration_Meetings_via_Cloud" <?php if($_POST[ 'enquiry']=="Messaging_Collaboration_Meetings_via_Cloud" ) echo "selected"; ?>>Messaging, Collaboration & Meetings via Cloud</option>
													<option value="Sizing_Re_sizing_IT_Infrastructure_on_Cloud" <?php if($_POST[ 'enquiry']=="Others" ) echo "selected"; ?>>Sizing & Re-sizing IT Infrastructure on Cloud</option>
													<option value="Messaging_Collaboration_Meetings_via_Cloud" <?php if($_POST[ 'enquiry']=="Others" ) echo "selected"; ?>>Others</option>
												</select>
											</div>
										</div>
									</div>
