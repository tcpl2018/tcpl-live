...
<title>Case Studies | Team Computers</title>
<meta name= "description" content= "Know how we have been delivering value to customers across the country. " />
			...
			<div class="row clearfix">
				<div class="valigncenter">
					<div class="jobs-header case-studies-hdr">
						...
						<button data-rel="auto" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Automative</button>
						<button data-rel="banking" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Banking</button>
						<button data-rel="consumer" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Consumer</button>
						<button data-rel="energy" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Energy</button>
						<button data-rel="fin" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Financial</button>
						<button data-rel="insurance" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Insurance</button>
						<button data-rel="legal" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">legal</button>
						<button data-rel="retail" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Retail</button>
						<button data-rel="manufacturing" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Manufacturing</button>
						<button data-rel="tech" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Technology</button>
						<button data-rel="telecom" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Telecommunications</button>
						<button data-rel="transportation" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Transpotation</button>
						<button data-rel="electronic" type="button" class="fil-cat btn pmd-btn-outline pmd-ripple-effect btn-default">Electronics</button>
					</div>
				</div>
			</div>
		</div>
	  ...
	  <div class="container">
		<div class="solutions-inner clearfix">
		  <div id="portfolio" class="row">
		  	<?php 
	      	$getAllCasestudies = $this->site_mdl->getAllCasestudy();
	      	//test($getAllCasestudies);
	      	foreach ($getAllCasestudies as $getAllCasestudy) {
	      	?>
			 <div class="col-md-6 col-sm-6 col-xs-12 newsroom-box-cvr scale-anm auto all">
			  <a href="case-studies-inner?caseid=<?php echo $getAllCasestudy['case_id']; ?>">
			  <div class="rel-cmn-box newsroom-box cs-box">
				<figure>
					<img src="<?php echo CASE_STUDY_SHOW_PATH.$getAllCasestudy['case_thumbnail_image']; ?>" alt="Image">

				<figcaption>
					<span><?php echo substr($getAllCasestudy['case_name'],0,110); ?></span>  
					<span><?php 
				if(isset($getAllCasestudy['case_sector_name']) && !empty($getAllCasestudy['case_sector_name'])){
        		echo $getAllCasestudy['case_sector_name'];
        	}else{
