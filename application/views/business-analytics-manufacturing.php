...
<title>Manufacturing Analytics Solutions, India | Team Computers</title>
<meta name="description" content="All your business related data on a single dashboard. Now take smart business decision on the basis of data with Team Computers Manufacturing Analytics Solutions. " />
...
<section class="banner-cover">
  <div class="banner ba-manu">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Manufacturing Analytics Solutions</h1>
        <h2>Reduce wastage and <br>
improve performance <br>
across your supply chain. </h2> 
...
<section class="cmn-padd insights auto-ana">
  <div class="container">
    <div class="insight-inner clearfix">
      <h2 class="cmn-hdr">
        <span class="line-text">Methodology</span>
      </h2>
      <div class="row">
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box1">
            <div class="insights-icon clearfix">
              ...
              <p>Deep dive into your business and analytics goals to develop an analytics strategy tailored to your needs.</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box2">
            <div class="insights-icon clearfix">
              ...
              <p>Data <br> Preparation<br> &<br> Visualization </p>
              <p>Integrate, model and crunch your data no matter the data source or quality. Get Dashboards with visually pleasing user interfaces and charts for your most important KPIs.</p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box3">
            <div class="insights-icon clearfix">
              ...
              <p>Deployment</p>
              <p>From adding a layer of security and governance to distribution through automated emails, embedded dashboards, mobile apps or chatbots, we’ve done it all for our clients. </p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box4">
            <div class="insights-icon clearfix">
              ...
              <p>Adoption &<br> Optimization </p>
              <p>Your BI solution is useful only when your business embraces it. Run specialized adoption programs built to kickstart and sustain the use of analytics within your organization. Ensure optimum performance with our support and maintenance services. </p>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-xs-12 col-sm-4 in-cmn-box">
          <div class="insight-cmn-bx box5">
            <div class="insights-icon clearfix">
              ...
              <p>Training </p>
              <p>The Institute of Business Intelligence addresses the analytics training needs of organizations that want to have end to end control of their analytics and for individuals looking to pursue a career in analytics.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<section class="cmn-padd solutions use-cases">
  <div class="container">
    <div class="solutions-inner clearfix">
      <h2 class="cmn-hdr">
        
        <span class="line-text">Use Cases</span>
      </h2>
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/ven-part-pri.png" alt="vendor part pricing icon">
              <p>Supply Chain Strategy</p>
              <div class="clearfix"></div>
              <p>Track delivery of raw material and finished products from one plant to another, one department to another, plant to warehouse and from warehouse to customer. Reduce the supply chain cycle time.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Operational Cost Dashboard</p>
              <div class="clearfix"></div>
              <p>Roll up all department costs including distribution costs, procurement costs, warehousing costs, transportation costs, and manufacturing costs. Arrive at critical KPI's like cost of goods sold, cost per unit, or cost per kilogram.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Wastage/Rejection Analysis</p>
              <div class="clearfix"></div>
              <p>Analysis of wastage and rejection at various levels like supplier, assembly line process, quality parameter, nature of defect and frequency of rejection. Administer tight controls on costs.
</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Inventory/Supply Variability Dashboard</p>
              <div class="clearfix"></div>
              <p>Monitor total inventory, inventory turns, obsolete inventory, working inventory, and non-working inventory. Increase conformance to lead times and promise dates. </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Spare Part pricing</p>
              <div class="clearfix"></div>
              <p>Strategic analytics to determine the pricing of spare parts and margin distribution across the entire value chain. Increase Spare Part penetration and expand profitability.
</p>
            </div>
          </div>
        </div>
	...
	<div class="container">
		<div class="solutions-inner clearfix">
			...
			<div id="partner-carousel" class="owl-carousel owl-theme">
				...
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/BA/Tableu---Silver-Partner.png" alt="tableau"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/BA/Alteryx---Master-reseller.png" alt="Alteryx"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/BA/sas.png" alt="SAS"> </figure>
				</div>
				<div class="item part-tech-cmn-box">
					<figure> <img src="images/Partners-logo/BA/Power-BI.png" alt="Power BI"> </figure>
				</div>
			</div>
		</div>
	</div>
...
<div class="clearfix"></div>
<?php
$getAllCasestudies = $this->site_mdl->getMainCaseStudyAnalyticsManufacturing();
    ...
    <div class="bookmyshow row clearfix">
	  ...
	  <div class="bms-txt col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
        <div class="bms-txt-inner">
          <div class="p-cover">
            <p>CASE STUDY</p>
            <h2><?php echo echoStr(substr($getAllCasestudy['case_name'],0,72));?></h2>
  ...
  <div class="container exp-more">
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        <div class="dig-ag"><a href="business-analytics-automotive">
          ...
          <br>
          Automotive</a></div>
        <div class="dig-ag"><a href="business-analytics-insurance">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Insurance</a></div>
        <div class="dig-ag"><a href="business-analytics-banking">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Banking</a></div>
        <div class="dig-ag"><a href="business-analytics-nbfc">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          NBFC</a></div>
        <div class="dig-ag"><a href="business-analytics-government">
          <div class="valigncenter img-box">
			<i>
          ...
          <br>
          Government</a></div>
        <div class="dig-ag"><a href="business-analytics-chatbot">
          <div class="valigncenter img-box">
			<i>
