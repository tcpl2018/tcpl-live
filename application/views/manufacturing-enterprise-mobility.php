...
<title>Enterprise mobility for manufacturing industry | Team Computers</title>
<meta name="description" content="Manage your manufacturing, distribution, sales & all other business process through Team Computers enterprise mobility solutions for manufacturing industry." />
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Product portfolio on the go</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Track order, service details</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Facilitate dealer inventory</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Training and productivity on the go </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_manufacturing_enterprise_mobility();
    ...
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        ...
        <div class="dig-ag"><a href="insurance-mobility-solutions">
          ...
          <br>
          Insurance</a></div>
		  <div class="dig-ag"><a href="pharmaceutical-mobility-solutions">
          <div class="valigncenter img-box">
			<i>
