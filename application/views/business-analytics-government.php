...
<title>Government & Public Sector Analytics, India | Team Computers</title>
<meta name="description" content="Now Governments can use Team Computers analytics solution to improve public services & safety. It can also help in analyzing & measuring the performance of programs & schemes." />
...
<section class="banner-cover">
  <div class="banner ba-gov">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Government & Public <br>
Sector Analytics</h1>
        <h2>Analytics Solutions <br>
to help serve the <br>
people better</h2> 
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/ven-part-pri.png" alt="vendor part pricing icon">
              <p>Scheme and program management</p>
              <div class="clearfix"></div>
              <p>Measure program/scheme success and encourage data exploration across      federal, state and local organizations. Improve efficiency in allocation of budgets.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>CM Dashboard</p>
              <div class="clearfix"></div>
              <p>Bring ease in monitoring state and department wise KPIs through one application embedded on a public portal. Increase transparency and empower citizen action. </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Crime Analytics</p>
              <div class="clearfix"></div>
              <p>A 360° Time pattern analysis of the crime case such as frequent occurrence of vehicle thefts, pickpocketing etc. Deploy patrol team at the right place at the right time</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Treasury and finance</p>
              <div class="clearfix"></div>
              <p>Provide insights of revenue and expenditure transactions data for policy decision making.
Gain a  holistic understanding of the implementation of State Budget at Department, Head of Department, Drawing & Disbursing Officer levels.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<?php
$getAllCasestudies = $this->site_mdl->getMainCaseStudyAnalyticsGovernment();
