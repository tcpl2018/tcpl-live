...
<title>Insurance Mobility Solutions & Mobility Services | Team Computers</title>
<meta name="description" content="Manage your insurance business with Team Computers Insurance Mobility Solutions. Now it's easy to manage customers, employees & all business process on the go." />
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Scheduling, Pull out pricing, Display etc</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
...
<div class="clearfix"></div>
<?php 
          $getAllCasestudies = $this->site_mdl->getINSMainCasestudy_insurance_mobility_solutions();
