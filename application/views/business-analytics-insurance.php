...
<title>Insurance Analytics & BI Solutions, India | Team Computers</title>
<meta name="description" content="Bring Analytics in your insurance business to manage risk, improve customer satisfaction & to optimize business processes." />
...
<section class="banner-cover">
  <div class="banner ba-insu">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Insurance Analytics & BI Solutions </h1>
        <h2>Let analytics insure your business risks so you <br>
can focus on covering them
for others.</h2> 
...
<section class="cmn-padd insights auto-ana">
  <div class="container">
    <div class="insight-inner clearfix">
      <h2 class="sec-hd">Methodology</h2>
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/ven-part-pri.png" alt="vendor part pricing icon">
              <p>Premium Inflow</p>
              <div class="clearfix"></div>
              <p>Dashboards to track LOB wise premiums and NOPs and their fluctuations month on month. Track product and channel wise performance of the premium numbers.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Claim Trends</p>
              <div class="clearfix"></div>
              <p>Track your claims across different parameters ranging from early claims, intimated, paid and outstanding claims. Comparison of current year vs previous year gives can also be visualized.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Channel/Agent Scorecards</p>
              <div class="clearfix"></div>
              <p>Development and deployment of scorecards to track and improve the sales and service performance of channels/agents across the country. Determine incentive payout and encourage agents to over achieve targets.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Loss Analytics</p>
              <div class="clearfix"></div>
              <p>Deep analytics of key insurance ratios like Gross Loss Ratio, Net Loss Ratio, Combined Ratio and more. Review and predict the points of failure. Improve Loss ratios and increase profitability.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Loss Triangles</p>
              <div class="clearfix"></div>
              <p>Various loss triangles like accident year wise etc help you to understand the pattern and enables you to maintain appropriate reserves</p>
            </div>
          </div>
        </div>
		  <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              ...
              <div class="clearfix"></div>
              <p>All regulatory reporting needs for underwriting, Finance & Actuarial are catered and made available for filing to IRDA.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="clearfix"></div>
<?php
$getAllCasestudies = $this->site_mdl->getMainCaseStudyAnalyticsInsurance();
