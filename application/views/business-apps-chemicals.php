...
<title>Chemical-ERP Software Services & Solutions, India | Team Computers</title>
<meta name="description" content="Team Computers ERP Software Services & Solutions offers inventory management, profitability tracking, product life cycle, batch tracking and many more functions over a single platform." />
...
<section class="banner-cover">
  <div class="banner bapps-chem">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>Chemical - <br>
ERP Software Services & Solutions</h1>
        <h2>Digital processes <br>
for Chemicals</h2> 
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Inventory Management – Location, Quality, Properties</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>By- Product & Co-Product Accounting</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/space-part-pricing.png" alt="vendor part pricing icon">
              <p>Product Costing & Profitability Tracking</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Product Life Cycle/Shelf Life Management</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Master production scheduling</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Make-to-stock and Make-to-order Operations </p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
          ...
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/service-dashboard.png" alt="vendor part pricing icon">
              <p>Complete Tracking and Accountability of Disposed By-products</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="first-row valigncenter" style="flex-wrap: wrap;">
        ...
        <div class="dig-ag"><a href="business-apps-construction">
		  ...
		  <div class="dig-ag"><a href="business-apps-legal">
          <div class="valigncenter img-box">
			  <i>
