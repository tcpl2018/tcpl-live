...
<title>IT Staffing, IT Staff Augmentation Services, India | Team Computers</title>
<meta name="description" content="Team Computers Staff Augmentation Services (SAS) focusing on providing skilled resources to businesses at the right time and at the right cost." />
...
<section class="banner-cover">
  <div class="banner ms-sas">
    <div class="container banner-text-cvr ">
    <div class="banner-text col-md-6 col-sm-6 col-xs-12">
      <h1>IT Staffing, <br>
IT Staff Augmentation Services</h1>
        <h2>Committed and competent<br> staffing</h2> 
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> 
              ...
              <p>Highly skilled resources on demand and at the right cost</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/dealer-scorecards-icon.png" alt="vendor part pricing icon">
              <p>Availability of backup resources to manage leaves, absenteeism and attrition</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12 main-cmn-box">
          <div class="automative-box sol-cmn-box">
            <div class="sol-cmn-box-inner clearfix"> <img src="images/warranty-dashboard.png" alt="vendor part pricing icon">
              <p>Personalized training and roadmap for all resources ensuring customer satisfaction</p>
              <div class="clearfix"></div>
            </div>
          </div>
        </div>
